...
const navLinks = [
  ...
  { label: "Culinary Tour", href: "/packages/culinary_tour" },
  { label: "Family Dinner", href: "/packages/family_dinner" },
...
>
  <Image src="/images/logo1.png" alt="Joy Tours of India" width={36} height={36} className="rounded-full" />
...
export function Footer() {
  ...
  <Image src="/public/images/logo.png" alt="Joy Tours of India" width={32} height={32} className="h-[1em] w-[1em] rounded-full" />
