...
import { Plane, Landmark, Heart, Mountain, PlaneTakeoff, ChevronDown, Clock, MapPin } from "lucide-react";
...
const days = [
  ...
  { id: 4,image: "/images/packages/red_fort.webp", icon: Landmark, title: "Agra → Delhi", place: "New Delhi", subtitle: "Overnight Delhi", travel: "Drive back to Delhi", highlights: ["Checkout after breakfast", "Red Fort visit", "Drive back to Delhi"], tone: "accent" },
  { id: 5, image: "/images/packages/arrival.webp", icon: PlaneTakeoff, title: "Delhi → Aurangabad", place: "Aurangabad", subtitle: "Overnight Aurangabad", travel: "Flight", highlights: ["Morning flight to Aurangabad", "Gateway to the Ajanta & Ellora caves"], tone: "primary" },
  { id: 6, image: "/images/packages/ajanta.webp", icon: Landmark, title: "Ajanta Caves", place: "Aurangabad", subtitle: "Day trip · Overnight Aurangabad", travel: "~100 km round trip", highlights: ["2nd-century BC rock-cut sculptures", "Ancient Buddhist murals in natural pigment"], tone: "accent" },
  { id: 7, image: "/images/packages/ellora.webp", icon: PlaneTakeoff, title: "Ellora Caves → Mumbai", place: "Mumbai", subtitle: "Overnight Mumbai", travel: "Day trip + evening flight", highlights: ["34 rock-cut monasteries & temples", "Kailash Temple, Cave 16", "Evening flight to Mumbai"], tone: "primary" },
  { id: 8, image: "/images/packages/temple.webp", icon: Mountain, title: "Mumbai → Hampi", place: "Hampi", subtitle: "Via Hubli · Overnight Hampi", travel: "Flight to Hubli, then drive", highlights: ["Virupaksha Temple", "The King's Balance & Pushkarni tank", "Hazara Rama Temple & Elephant Stables", "Vittala Temple & Stone Chariot"], tone: "accent" },
  { id:9, image: "/images/packages/hampi.webp", icon: Mountain, title: "Hampi Sightseeing", place: "Hampi", subtitle: "Overnight Hampi", travel: "Full day exploring the ruins", highlights: ["Explore the ancient Vijayanagar capital", "Boulder-strewn riverside landscape", "Malyavanta Raghunatha Temple viewpoint"], tone: "primary" },
  { id: 10, image: "/images/packages/departure.webp", icon: PlaneTakeoff, title: "Depart via Hubli", place: "Hubli → Delhi/Mumbai", subtitle: "Onward journey", travel: "Drive to Hubli, flight home", highlights: ["Drive to Hubli Airport", "Flight to Delhi or Mumbai", "Arrival transfer to hotel"], tone: "accent" },
];
  ...
  return (
    <section className="relative bg-[#FAFAF7] px-6 py-16 sm:py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-3 font-serif text-4xl text-[#1B1B1B] sm:text-5xl">Ten days, five destinations, one story</h2>
