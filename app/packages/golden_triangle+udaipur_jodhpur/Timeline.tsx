...
const days = [
  ...
  { id: 9, image: "/images/packages/pushkar.webp", icon: PlaneTakeoff, title: "Udaipur → Pushkar", place: "Pushkar", subtitle: "Overnight Pushkar", travel: "Drive to Pushkar", highlights: ["Drive to Pushkar", "Visit the Brahma Temple"], tone: "primary" },
