...
const days = [
  ...
  { id: 4, image: "/images/packages/abhaneri.webp", icon: Castle, title: "Drive to Ranthambore", place: "Ranthambore", subtitle: "Via Fatehpur Sikri & Chand Baori · Overnight Ranthambore", travel: "Full day drive, with stops", highlights: ["Fatehpur Sikri fort", "Lunch break enroute", "Chand Baori stepwell (Abhaneri)", "Arrive Ranthambore through rural landscape"], tone: "accent" },
