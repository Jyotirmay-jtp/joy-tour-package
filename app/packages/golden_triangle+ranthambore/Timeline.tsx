...
import { Plane, Landmark, Heart, TreePine, Binoculars, Castle, PlaneTakeoff, ChevronDown, Clock, MapPin } from "lucide-react";
...
const days = [
  ...
  { id: 8, image: "/images/packages/departure.webp", icon: PlaneTakeoff, title: "Return to Delhi", place: "New Delhi", subtitle: "Onward journey", travel:"Drive back to Delhi", highlights: ["Breakfast", "Drive back to Delhi", "Connect to your next embarkment"], tone: "accent" },
];
  ...
  return (
    <section className="relative bg-[#FAFAF7] px-6 py-16 sm:py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-3 font-serif text-4xl text-[#1B1B1B] sm:text-5xl">Eight days, four destinations, one story</h2>
