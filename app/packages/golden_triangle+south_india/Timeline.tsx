...
import { Plane, Landmark, Heart, TreePine, Binoculars, Castle, PlaneTakeoff, Sailboat, ChevronDown, Clock, MapPin } from "lucide-react";
...
const days = [
  ...
  { id: 4,image: "/images/packages/chand_baori.webp", icon: Castle, title: "Drive to Ranthambore", place: "Ranthambore", subtitle: "Via Fatehpur Sikri & Chand Baori · Overnight Ranthambore", travel: "Full day drive, with stops", highlights: ["Fatehpur Sikri fort", "Lunch break enroute", "Chand Baori stepwell (Abhaneri)", "Arrive through rural landscape"], tone: "accent" },
  { id: 5, image: "/images/packages/safari.webp", icon: Binoculars, title: "Safaris in Ranthambore", place: "Ranthambore", subtitle: "Morning and evening safaris · Overnight Ranthambore", travel: "2 safaris, ~4 hrs each", highlights: ["Morning safari", "Evening safari", "Optional: Ranthambore Fort visit"], tone: "primary" },
  { id: 6, image: "/images/packages/departure.webp", icon: TreePine, title: "Drive to Jaipur", place: "Jaipur", subtitle: "Overnight Jaipur", travel: "Checkout after breakfast, drive to Jaipur", highlights: ["Checkout Ranthambore", "Drive to Jaipur", "Check-in hotel"], tone: "accent" },
  { id: 7, image: "/images/packages/jantar_mantar.webp", icon: Landmark, title: "Full Day Jaipur Sightseeing", place: "Jaipur, the Pink City", subtitle: "Overnight Jaipur", travel: "Full day · City transfers", highlights: ["Amber Palace (car, elephant or on foot)", "Local shopping — jewellery, block print, blue pottery", "City Palace Museum", "Jantar Mantar observatory"], tone: "primary" },
  { id: 8, image: "/images/packages/narlai.webp", icon: Castle, title: "Drive to Narlai", place: "Narlai", subtitle: "Heritage Rawla stay · Overnight Narlai", travel: "Drive · ~6 hrs", highlights: ["Check into heritage lodge", "Bullock-cart ride to a 300-yr-old stepwell", "Candlelit dinner with live folk performance"], tone: "accent" },
  { id: 9, image: "/images/packages/ranakpur.webp", icon: TreePine, title: "Narlai → Udaipur", place: "Udaipur", subtitle: "Via Ranakpur · Overnight Udaipur", travel: "Drive · ~90 km from Ranakpur", highlights: ["Leopard safari or elephant boulder ascent", "Ranakpur Jain temple — 1,444 carved pillars", "Scenic countryside drive to Udaipur"], tone: "primary" },
  { id: 10, image: "/images/packages/udaipur.webp", icon: Landmark, title: "Udaipur City Tour", place: "Udaipur", subtitle: "Overnight Udaipur", travel: "Full day · City transfers + cruise", highlights: ["Monsoon Palace viewpoint", "Old-city bazaars & miniature painting gallery", "City Palace & Crystal Gallery", "Sunset cruise on Lake Pichola"], tone: "accent" },
  { id: 11, image: "/images/packages/departure.webp", icon: PlaneTakeoff, title: "Udaipur → Aurangabad", place: "Aurangabad", subtitle: "Via Hyderabad · Overnight Aurangabad", travel: "Flight, layover in Hyderabad", highlights: ["Afternoon flight with layover", "Gateway to the Ajanta & Ellora caves"], tone: "primary" },
  { id: 12, image: "/images/packages/ajanta.webp", icon: Landmark, title: "Ajanta Caves", place: "Aurangabad", subtitle: "Day trip · Overnight Aurangabad", travel: "~100 km round trip", highlights: ["2nd-century BC rock-cut sculptures", "Ancient Buddhist murals in natural pigment"], tone: "accent" },
  { id: 13, image: "/images/packages/ellora.webp", icon: PlaneTakeoff, title: "Ellora Caves → Mumbai", place: "Mumbai", subtitle: "Overnight Mumbai", travel: "Day trip + evening flight", highlights: ["34 rock-cut monasteries & temples", "Kailash Temple, Cave 16", "Evening flight to Mumbai"], tone: "primary" },
  { id: 14, image: "/images/packages/goi.webp", icon: Landmark, title: "Mumbai Sightseeing", place: "Mumbai", subtitle: "Overnight Mumbai", travel: "Full day · City transfers", highlights: ["Gateway of India", "Chhatrapati Shivaji Terminus", "Prince of Wales Museum", "Dhobi Ghat & Malabar Hill"], tone: "accent" },
  { id: 15,image: "/images/packages/kochi.webp", icon: PlaneTakeoff, title: "Mumbai → Fort Kochi", place: "Kochi", subtitle: "Overnight Kochi", travel: "Flight", highlights: ["Arrive Fort Kochi, colonial old town", "Evening Kathakali dance performance"], tone: "primary" },
  { id: 16,image: "/images/packages/church.webp", icon: Landmark, title: "Fort Kochi Tour", place: "Kochi", subtitle: "Overnight Kochi", travel: "Full day · Walking + transfers", highlights: ["Chinese fishing nets", "St. Francis Church & Santa Cruz Basilica", "Paradesi Synagogue", "Mattancherry Palace murals"], tone: "accent" },
  { id: 17,image: "/images/packages/houseboat.webp", icon: Sailboat, title: "Kochi → Alleppey Houseboat", place: "Alleppey", subtitle: "Overnight houseboat", travel: "Drive · 55 km", highlights: ["Board private Kerala houseboat", "Cruise the backwaters & coconut-lined canals"], tone: "primary" },
  { id: 18, image: "/images/packages/beach.webp",icon: PlaneTakeoff, title: "Alleppey → Delhi", place: "New Delhi", subtitle: "Via Cochin Airport · Overnight Delhi", travel: "Drive + flight", highlights: ["Vypin Island & Cherai Beach", "Oldest Portuguese fort in India", "Evening flight to Delhi"], tone: "accent" },
  { id: 19, image: "/images/packages/departure.webp", icon: Plane, title: "Depart Delhi", place: "New Delhi", subtitle: "Onward journey", travel: "Hotel → Airport", highlights: ["Checkout", "Transfer to international airport"], tone: "primary" },
];
  ...
  return (
    <section className="relative bg-[#FAFAF7] px-6 py-16 sm:py-20">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-3 font-serif text-4xl text-[#1B1B1B] sm:text-5xl">Nineteen days, ten destinations, one story</h2>
